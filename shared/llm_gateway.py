...
class LLMGateway:
        ...
        while True:
            ...
            try:
                async with self._sem:
                    ...
                    elif name in {'openai', 'kimi', 'deepseek', 'qwen'}:
    ...
    async def health(self) -> dict[str, Any]:
        ...
        usable = providers['ollama']['ok'] or providers['huggingface']['ok'] or any(
            p['configured'] and not p['breaker_open'] for n, p in providers.items() if n not in ('ollama', 'huggingface')
        )
