...
def _seed_registry() -> None:
    ...
    _REGISTRY.extend([
        ...
        ModelInfo("qwen2.5:0.5b", "ollama", 0.5, "Q4_K_M", 0.5, 1.5, ModelCapability(text=True, code=True, speed_rating=5, quality_rating=2, offline_capable=True)),
        ModelInfo("qwen2.5:1.5b", "ollama", 1.5, "Q4_K_M", 1.2, 3.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=5, quality_rating=3, offline_capable=True)),
        ModelInfo("qwen2.5:3b", "ollama", 3.0, "Q4_K_M", 2.2, 5.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=4, quality_rating=3, offline_capable=True)),
        ModelInfo("qwen2.5:7b", "ollama", 7.0, "Q4_K_M", 5.0, 10.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=3, quality_rating=4, offline_capable=True)),
        ModelInfo("qwen2.5:14b", "ollama", 14.0, "Q4_K_M", 9.0, 18.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=2, quality_rating=5, offline_capable=True)),
        ModelInfo("llama3.2:1b", "ollama", 1.0, "Q4_K_M", 1.0, 2.0, ModelCapability(text=True, code=True, speed_rating=5, quality_rating=2, offline_capable=True)),
        ModelInfo("llama3.2:3b", "ollama", 3.0, "Q4_K_M", 2.2, 5.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=4, quality_rating=3, offline_capable=True)),
        ...
        ModelInfo("meta-llama/Llama-3.2-3B-Instruct", "huggingface", 3.0, "fp16", 2.5, 5.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=4, quality_rating=3, offline_capable=True), aliases=["llama-3.2-3b-instruct"]),
        ModelInfo("Qwen/Qwen2.5-7B-Instruct", "huggingface", 7.0, "fp16", 5.0, 10.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=3, quality_rating=4, offline_capable=True), aliases=["qwen2.5-7b-instruct-hf"]),
        ModelInfo("Qwen/Qwen2.5-14B-Instruct", "huggingface", 14.0, "fp16", 9.0, 18.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=2, quality_rating=5, offline_capable=True), aliases=["qwen2.5-14b-instruct-hf"]),
    ...
    _REGISTRY.extend([
        ...
        ModelInfo("kimi-k1.5", "kimi", 30.0, "fp16", 0.0, 0.0, ModelCapability(text=True, code=True, reasoning=True, speed_rating=3, quality_rating=4, offline_capable=False), cost_per_1k_tokens=0.00015),
    ])
